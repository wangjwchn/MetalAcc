...
kernel void ImageLevels(texture2d<float, access::read> inTexture [[texture(0)]],
                       texture2d<float, access::write> outTexture [[texture(1)]],
                        device float *minR [[buffer(0)]],
                        device float *minG [[buffer(1)]],
                        device float *minB [[buffer(2)]],
                        device float *midR [[buffer(3)]],
                        device float *midG [[buffer(4)]],
                        device float *midB [[buffer(5)]],
                        device float *maxR [[buffer(6)]],
                        device float *maxG [[buffer(7)]],
                        device float *maxB [[buffer(8)]],
                        device float *minOutR [[buffer(9)]],
                       ...
                       uint2 gid [[thread_position_in_grid]])
{
    ...
    float4 outColor = float4(LevelsControl(inColor.rgb, levelMinimum, levelMiddle, levelMaximum, minOutput, maxOutput), inColor.a);
